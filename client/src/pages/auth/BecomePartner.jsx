...
const BecomePartner = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    role: "business", // Fixed: lowercase to match schema/validation checks
    companyName: "",
    description: "",
    category: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("Business account created successfully! Redirecting...");
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                {loading ? "Registering..." : "Register the business"}
              </button>
            </div>
          </form>
